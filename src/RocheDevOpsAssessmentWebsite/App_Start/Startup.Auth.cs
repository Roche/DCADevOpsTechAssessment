...
using Owin;
using RocheDevOpsAssessment.Areas.Admin;
using RocheDevOpsAssessment.Models;
using RocheDevOpsAssessment.Security;
...
namespace RocheDevOpsAssessment
{
    public partial class Startup
    {
        public static void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(() => Global.UnityContainer.Resolve<IRocheDevOpsAssessmentContext>());
            ...
            var userManager = CreateUserManager(null, (RocheDevOpsAssessmentContext)Global.UnityContainer.Resolve<IRocheDevOpsAssessmentContext>());
        ...
        {
            return CreateUserManager(options.DataProtectionProvider, context.Get<IRocheDevOpsAssessmentContext>());
        }

        public static UserManager<ApplicationUser> CreateUserManager(IDataProtectionProvider dataProtectionProvider, IRocheDevOpsAssessmentContext context)
        {
        ...
        {
            var roleManager = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(new RocheDevOpsAssessmentContext()));
