...
{
    public class RocheDevOpsAssessmentDbInitializer : CreateDatabaseIfNotExists<RocheDevOpsAssessmentContext>
    {
        protected override void Seed(RocheDevOpsAssessmentContext context)
        {
